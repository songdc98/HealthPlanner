...
> This project was completed jointly by me and Codex.  
> If you are interested in this project, please contact me at [dsong25@gmu.edu](mailto:dsong25@gmu.edu).  
> Thank you for your attention.

HealthPlanner is a local-only iPhone health and training planner App built with SwiftUI and HealthKit. It combines Apple Health data, personal baselines, workout history, recovery modeling, and a user profile to generate adaptive daily recommendations without a backend, cloud sync, or login.

## Core Product Idea

HealthPlanner acts as a lightweight personal recovery and training coach. Instead of only showing raw Apple Health data, it interprets your current body state and recent training context to answer questions such as:
...
- Resting heart rate and HRV are compared against your personal baseline rather than generic thresholds
...
**Why this matters:**
- A resting heart rate of 60 may be good for one person and elevated for another
...
The app converts profile data into a reusable capability layer instead of only storing it.
...
- Bench, pulldown, and squat estimates influence load guidance
...
The app supports in-app language switching independently of the system language.
...
All core app data is stored locally on the device.
...
HealthPlanner is more than a metric dashboard. It is a local, adaptive, profile-aware recovery and training planner that combines:
...
This project was completed jointly by me and Codex. If you are interested in this project, please contact me at [dsong25@gmu.edu](mailto:dsong25@gmu.edu).
